...
public class Joaopapodepescador {
	...
	public static void main(String[] args) {
		...
		System.out.println("Peso do peixe"); // print para pedir o peso do peixe
		...
		System.out.println("O peixe passou "+ passoupeso + "kg. O total será : R$ " + df.format(pesopermitido)); // aqui temos, duas variaveis texto que sera impressa na tela e, usamos a formatacao df.format para a variavel 'pesopermitido'
		}
		else {
			System.out.println("O peixe está no peso permitido, nao houve excesso");
