...
public class Joaopapodepescador {
	...
	public static void main(String[] args) {
		...
		if (pesopeixe > 50) { // se peixe é maior que o valor 50
			double passoupeso = pesopeixe - 50; // variavel do tipo double, diminuimos por 50 o valor da variavel 'pesopeixe'e a  sobra será o valor armazenado no double 'passoupeso' 
